...
export const coreAreasOfStudy = [
  ...
  export const experienceSalary = [
    { experience: "0-1 YEARS EXPERIENCE", salaryRange: "$80,000 - $120,000" },
    { experience: "1-3 YEARS EXPERIENCE", salaryRange: "$100,000 - $144,000" },
    { experience: "4-6 YEARS EXPERIENCE", salaryRange: "$120,000 - $150,000" },
    { experience: "7-9 YEARS EXPERIENCE", salaryRange: "$125,000 - $159,000" }
  ];
...
export const countries = ["🇺🇸", "🇲🇾", "🇿🇲"];
  ...
  export const topcourses = [

    {
      ...
      description: `Professionals develop intelligent systems that can learn, reason, and perform tasks autonomously. This field encompasses creating algorithms for pattern recognition, natural language processing, and decision-making in complex environments.`
    },
    {
      name: "CYBERSECURITY",
      salaryRange: "$140,000 - $200,000",
      description: `Protect digital assets, networks, and systems from unauthorized access and cyber threats. Involves implementing security measures, conducting risk assessments, and developing incident response strategies.`
    },
    {
      name: "CLOUD COMPUTING",
      salaryRange: "$145,000 - $210,000",
      description: `Design, implement, and manage cloud-based infrastructure and services. Focus on scalable, flexible computing resources delivered over the internet, enabling efficient data storage and application deployment.`
    },
    {
      name: "SOFTWARE DEVELOPMENT",
      salaryRange: "$135,000 - $195,000",
      description: `Create, test, and maintain software applications for various platforms. Involves analyzing user needs, designing software solutions, and writing code to implement functionality and features.`
    },
    {
      name: "DATA SCIENCE",
      salaryRange: "$130,000 - $190,000",
      description: `Extract insights from complex data sets using statistical analysis, machine learning, and data visualization techniques. Helps organizations make data-driven decisions and optimize processes.`
    },
    {
      name: "GAME DEVELOPMENT",
      salaryRange: "$125,000 - $185,000",
      description: `Design and develop interactive video games for various platforms. Involves programming game mechanics, creating graphics, implementing AI, and optimizing performance for engaging user experiences.`
    },
    {
      name: "WEB DEVELOPMENT",
      salaryRange: "$120,000 - $180,000",
      description: `Create and maintain websites and web applications. Involves front-end and back-end development, ensuring functionality, performance, and user experience across various devices and browsers.`
    },
    {
      name: "IT SUPPORT & NETWORKING",
      salaryRange: "$115,000 - $175,000",
      description: `Manage and maintain computer systems and networks. Provide technical support, troubleshoot issues, and ensure smooth operation of IT infrastructure for organizations.`
    },
    {
      name: "DIGITAL MARKETING & ANALYTICS",
      salaryRange: "$110,000 - $170,000",
      description: `Develop and implement online marketing strategies. Utilize data analytics to optimize campaigns, improve user engagement, and drive conversions across digital platforms.`
    },
    {
      name: "UI/UX DESIGN",
      salaryRange: "$105,000 - $165,000",
      description: `Create intuitive and visually appealing user interfaces for digital products. Focus on enhancing user experience through research, prototyping, and iterative design processes.`
    }
  ];
  ...
  export const challengesArray = [
    ...
    {
      heading: "Course requires stiff time manangement",
    ...
    {
      heading: "Insufficient/Impoper mentorship guides",
