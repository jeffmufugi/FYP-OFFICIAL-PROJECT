...
const PhysicsEngineeringCourse= () => {
  ...
  return (
    <>
    <div className="cs-course-page" style={{background:"linear-gradient(to bottom, #60416D, #ffffffbb 80%)"}}>
      <Header1 />
      <Page1 
...
export default PhysicsEngineeringCourse;
