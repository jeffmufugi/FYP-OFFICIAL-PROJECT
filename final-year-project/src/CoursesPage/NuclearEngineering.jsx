...
import fadebg from "../site_icons/rectbb.png";
...
import {countries,topspecializations,
  ...
  homepageInfo,prerequisites,getTopCourses,homepageInfo2,homepageInfo1} from './nucextdata.jsx';
import { Page1,Page2,Page3,Page4,Page5, fadeInFromLeft} from "./a0Skeleton.jsx";


const NuclearEngineeringCourse= () => {
  ...
  return (
    <>
    <div className="cs-course-page" style={{background:"linear-gradient(to bottom, #4932B9, #ffffffbb 80%)"}}>
...
export default NuclearEngineeringCourse;
